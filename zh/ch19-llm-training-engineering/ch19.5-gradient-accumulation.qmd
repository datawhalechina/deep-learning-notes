...
open-graph:
  title: ch19.5-gradient-accumulation
  description: "19.5 Gradient Accumulation: Simulating a Larger Batch When Memory Is Limited"
title: "19.5 Gradient Accumulation：显存不够时如何模拟大 Batch"
order: 5
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch19-llm-training-engineering/ch19.5-gradient-accumulation.ipynb){fig-align="left"}
...
![图 19.5.1.1 普通参数更新示意图](figures/ch19.5-standard-training.svg){width=85%}

而变成：

![图 19.5.1.2 梯度累积示意图](figures/ch19.5-gradient-accumulation.png){width=50%}
