...
[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch7-regularization-and-normalization/ch7.2-dropout.ipynb){fig-align="left"}
...
![图 7.2.1 Dropout 让网络在训练时随机选择子网络 [@zhang2023d2l, fig. 4.6.1]](figures/ch7.2-dropout.svg)
...
::: {.list-table}
表 7.2.8 PyTorch 中不同 Dropout 模块的典型输入
