...
[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch14-diffusion-models/ch14.1-ddpm-basics.ipynb){fig-align="left"}
...
DDPM [@ho2020DDPM]，也就是 **Denoising Diffusion Probabilistic Model**，这个名字其实已经把它最重要的三个部分写出来了：
...
![图 14.1.3 DDPM 的前向扩散与反向生成过程 [@ho2020DDPM, fig. 2]](figures/ch14.1-ddpm-chain.png)
