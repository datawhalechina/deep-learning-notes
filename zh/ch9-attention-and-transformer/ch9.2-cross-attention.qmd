...
title: "9.2 Cross-Attention：一个序列查询另一个序列"
order: 2
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch9-attention-and-transformer/ch9.2-cross-attention.ipynb){fig-align="left"}
...
## 9.2.2 Query、Key、Value：动态信息检索的三要素
...
![图 9.2.6：SDPA 计算示意图 [@vaswani2023Attention, fig. 2]](figures/ch9.2-sdpa.png){height=250px}
...
## 9.2.8 Cross-Attention 在 Transformer 中的位置
