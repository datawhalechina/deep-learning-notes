...
title: "9.8 Encoder-Decoder Transformer：把 Encoder 和 Decoder 连接起来"
order: 8
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch9-attention-and-transformer/ch9.8-encoder-decoder-transformer.ipynb){fig-align="left"}
...
## 9.9.2 Encoder-Decoder Transformer 的信息流

完整 Encoder-Decoder Transformer 的信息流可以写成：

![图 9.9.2：Transformer 网络结构图 [@vaswani2023Attention, fig. 1]](figures/ch9.8-transformer.png){height=600px}
...
## 9.9.3 Teacher Forcing：训练时使用真实前缀并行预测
...
## 9.9.6 Transformer 的 PyTorch 实现

接下来，我们来完整实现一下 Encoder-Decoder Transformer。我们直接使用 9.6 和 9.7 中实现的 encoder block 和 decoder block，来构建一个完整的 Transformer 模型。
...
## 9.9.7 Seq2Seq Transformer 的 PyTorch 实现
...
这里的 `SinusoidalPositionalEncoding` 可以使用 9.5 中实现的版本。
...
## 9.9.8 Seq2Seq Transformer 的训练流程
