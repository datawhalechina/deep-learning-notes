...
open-graph:
  title: ch9.6-transformer-encoder
  description: "9.6 Transformer Encoder: Stacking Self-Attention Layers"
title: "9.6 Transformer Encoder：把 Self-Attention 堆起来"
order: 6
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch9-attention-and-transformer/ch9.6-transformer-encoder.ipynb){fig-align="left"}
...
![图 9.6.2：Transformer Encoder Block 结构图](figures/ch9.6-transformer-encoder-block.svg){height=600px}
...
### 9.6.2.1 第一部分：Multi-head Attention
...
### 9.6.2.2 第二部分：Residual Connection
...
### 9.6.2.3 第三部分：Layer Normalization
...
### 9.6.2.4 第四部分：Position-wise Feed-Forward Network
...
## 9.6.4 Transformer Encoder Block 的 PyTorch 实现

下面我们实现一个简化版 Transformer Encoder block。这里为了避免重复实现 multi-head attention，我们直接使用 9.4 节里实现的 `MultiheadAttention`。
