...
open-graph:
  title: ch9.7-transformer-decoder
  description: "9.7 Transformer Decoder: Masked Self-Attention and Cross-Attention"
title: "9.7 Transformer Decoder：Masked Self-Attention 与 Cross-Attention"
order: 7
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch9-attention-and-transformer/ch9.7-transformer-decoder.ipynb){fig-align="left"}
...
## 9.7.2 Masked Self-Attention：让 Decoder 不能偷看未来
...
## 9.7.3 Cross-Attention：让 Decoder 读取 Encoder 输出
...
![图 9.7.4：Transformer Decoder Block 结构图](figures/ch9.7-transformer-decoder-block.svg){height=800px}

和 encoder block 相比，decoder block 多了一个 cross-attention，并且 self-attention 需要 causal mask。

## 9.7.5 Transformer Decoder Block 的 PyTorch 实现

下面我们实现一个简化版 Transformer Decoder block。同样，我们直接使用 9.4 节里实现的 multi-head attention 模块，来构建 decoder block。
