...
open-graph:
  ...
  description: "9.10 Three Different Architectures of Transformer: Understanding, Generation, and Input-Output Conversion"
title: "9.10 Transformer 的三种不同架构：理解、生成与输入输出转换"
order: 10
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch9-attention-and-transformer/ch9.10-transformer-architectures.ipynb){fig-align="left"}
...
## 9.10.4 Encoder-Decoder：更适合输入到输出的转换
...
到这里，第 9 章关于 attention 和 Transformer 的主线已经基本完整了。接下来我们继续往实现方向走，用 Hugging Face Transformers 加载真实模型，观察不同架构在代码接口、输入输出和 attention mask 上的差异。
