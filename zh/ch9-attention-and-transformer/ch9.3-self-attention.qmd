...
title: "9.3 Self-Attention：序列内部的信息交互"
order: 3
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/zh/ch9-attention-and-transformer/ch9.3-self-attention.ipynb){fig-align="left"}
...
## 9.3.1 从 Cross-Attention 到 Self-Attention
...
## 9.3.3 Self-Attention 的 PyTorch 实现
...
![图 9.3.4：Self-Attention 动态信息示意图 [@vaswani2023Attention, fig. 5]](figures/ch9.3-self-attn-vis.png){width=80%}
...
## 9.3.5 Self-Attention 为什么适合建模序列
...
::: {.list-table}
表 9.3.5 RNN、CNN 和 Self-Attention 的对比
