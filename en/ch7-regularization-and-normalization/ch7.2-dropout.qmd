...
title: "7.2 Dropout: Reducing Overfitting through Random Deactivation"
order: 2
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/en/ch7-regularization-and-normalization/ch7.2-dropout.ipynb){fig-align="left"}
...
![Figure 7.2.1 Dropout randomly selects subnetworks during training [@zhang2023d2l, fig. 4.6.1]](figures/ch7.2-dropout.svg)
...
::: {.list-table}
Table 1: Typical Inputs for Different Dropout Modules in PyTorch
...
::: {.list-table}
Table 2: Core Properties of Dropout
