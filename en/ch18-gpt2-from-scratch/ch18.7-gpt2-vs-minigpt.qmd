...
open-graph:
  ...
  description: "18.7 GPT-2: From MiniGPT to a Pretrained Language Model"
title: "18.7 GPT-2: From MiniGPT to a Pretrained Language Model"
order: 7
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/en/ch18-gpt2-from-scratch/ch18.7-gpt2-vs-minigpt.ipynb){fig-align="left"}
...
## 18.7.1 MiniGPT and GPT-2 Are the Same Kind of Model
...
![Figure 18.7.1 GPT-2 Architecture](figures/ch18.7-gpt2-architecture.png){width=70%}
...
## 18.7.2 Different Configurations in the GPT-2 Family
...
::: {.list-table}
Table 18.7.2 GPT-2 Family Configurations
...
## 18.7.3 Parameter Initialization and Residual Scaling
...
## 18.7.4 Generating Text with a Hugging Face GPT-2
