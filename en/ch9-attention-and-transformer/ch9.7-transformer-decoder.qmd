...
open-graph:
  ...
  description: "9.7 Transformer Decoder: Masked Self-Attention and Cross-Attention"
title: "9.7 Transformer Decoder: Masked Self-Attention and Cross-Attention"
order: 7
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/en/ch9-attention-and-transformer/ch9.7-transformer-decoder.ipynb){fig-align="left"}
...
## 9.7.1 What Is Different Between the Decoder and the Encoder
...
## 9.7.2 Masked Self-Attention: Preventing the Decoder from Peeking at the Future
...
## 9.7.3 Cross-Attention: Letting the Decoder Read the Encoder Output
...
## 9.7.4 Overall Structure of the Decoder Block
...
![Figure 9.7.4: Transformer Decoder Block structure diagram](figures/ch9.7-transformer-decoder-block.svg){height=800px}
...
## 9.7.5 PyTorch Implementation of a Transformer Decoder Block
...
class TransformerDecoderLayer(nn.Module):
    """A simplified Transformer Decoder block with Pre-LN structure."""
    ...
    def __init__(
        ...
        self.norm3 = dnn.LayerNorm(d_model, bias=bias)
        self.dropout1 = dnn.Dropout(dropout)
        self.dropout2 = dnn.Dropout(dropout)
        self.dropout3 = dnn.Dropout(dropout)
...
## 9.7.7 Generating the Causal Mask
...
## 9.7.8 How the Decoder Is Used for Generation
