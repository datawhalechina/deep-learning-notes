...
open-graph:
  title: ch9.3-self-attention
  description: "9.3 Self-Attention: Internal Information Interaction Within a Sequence"
title: "9.3 Self-Attention: Internal Information Interaction Within a Sequence"
order: 3
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/en/ch9-attention-and-transformer/ch9.3-self-attention.ipynb){fig-align="left"}
...
## 9.3.1 From Cross-Attention to Self-Attention
...
## 9.3.2 How Each Token Obtains Context
...
## 9.3.3 PyTorch Implementation of Self-Attention
...
class SelfAttention(nn.Module):
    def __init__(self, embed_dim: int):
        ...
        self.q_proj = dnn.Linear(embed_dim, embed_dim)
        self.k_proj = dnn.Linear(embed_dim, embed_dim)
        self.v_proj = dnn.Linear(embed_dim, embed_dim)
        self.out_proj = dnn.Linear(embed_dim, embed_dim)
...
## 9.3.4 Self-Attention Is a Dynamic Information Graph
...
![Figure 9.3.4: Schematic diagram of dynamic information in Self-Attention [@vaswani2023Attention, fig. 5]](figures/ch9.3-self-attn-vis.png){width=80%}
...
## 9.3.5 Why Self-Attention Is Suitable for Sequence Modeling
...
::: {.list-table}
Table 9.3.5 Comparison of RNN, CNN, and Self-Attention
...
## 9.3.6 Limitations of Self-Attention
