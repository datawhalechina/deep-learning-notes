...
open-graph:
  title: ch9.2-cross-attention
  description: "9.2 Cross-Attention: One Sequence Querying Another Sequence"
title: "9.2 Cross-Attention: One Sequence Querying Another Sequence"
order: 2
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/en/ch9-attention-and-transformer/ch9.2-cross-attention.ipynb){fig-align="left"}
...
## 9.2.1 From Soft Alignment to Cross-Attention
...
## 9.2.2 Query, Key, and Value: Three Elements of Dynamic Information Retrieval
...
## 9.2.3 Why Split Them into Query, Key, and Value?
...
## 9.2.5 Matrix Form of Cross-Attention
...
![Figure 9.2.6: SDPA computation diagram [@vaswani2023Attention, fig. 2]](figures/ch9.2-sdpa.png){height=250px}
...
## 9.2.7 How One Target Position Queries the Entire Source Sequence
...
## 9.2.8 The Position of Cross-Attention in the Transformer
