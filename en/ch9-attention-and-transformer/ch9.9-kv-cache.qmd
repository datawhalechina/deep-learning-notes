...
open-graph:
  title: ch9.9-kv-cache
  description: "9.9 KV Cache: Why We Don't Recompute the Past During Inference"
title: "9.9 KV Cache: Why We Don't Recompute the Past During Inference"
order: 9
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/en/ch9-attention-and-transformer/ch9.9-kv-cache.ipynb){fig-align="left"}
...
## 9.9.1 Repeated Computation in Autoregressive Inference
...
## 9.9.2 Why We Cache K and V, Not Q
...
## 9.9.3 What Happens Without KV Cache
...
## 9.9.4 What Happens with KV Cache
...
![Figure 9.9.4: KV cache diagram](figures/ch9.9-kv-cache.svg)
...
## 9.9.5 The Cost of KV Cache: Faster, but More GPU Memory
...
## 9.9.6 A Simplified KV Cache Example
