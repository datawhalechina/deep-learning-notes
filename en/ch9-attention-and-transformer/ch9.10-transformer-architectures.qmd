...
open-graph:
  title: ch9.10-transformer-architectures
  description: "9.10 Three Different Transformer Architectures: Understanding, Generation, and Input-Output Conversion"
title: "9.10 Three Different Transformer Architectures: Understanding, Generation, and Input-Output Conversion"
order: 10
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/en/ch9-attention-and-transformer/ch9.10-transformer-architectures.ipynb){fig-align="left"}
...
## 9.10.1 Starting from the Original Transformer
...
## 9.10.2 Encoder-Only: Better for Understanding
...
## 9.10.3 Decoder-Only: Better for Generation
...
## 9.10.4 Encoder-Decoder: Better for Input-to-Output Conversion
...
## 9.10.5 Core Differences Between the Three Architectures
...
## 9.10.6 When to Use Which Structure
...
## 9.10.7 Why Decoder-Only Is So Popular Today
