...
open-graph:
  title: ch9.11-hugging-face-transformers-api
  description: "9.11 Hugging Face Transformers API: From Structure to Calls"
title: "9.11 Hugging Face Transformers API: From Structure to Calls"
order: 11
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/en/ch9-attention-and-transformer/ch9.11-hugging-face-transformers-api.ipynb){fig-align="left"}
...
## 9.11.1 The Basic Idea of the Transformers API
...
![Figure 9.11.1: Basic Hugging Face Transformers call flow](figures/ch9.11-transformers-pipeline.svg)
...
### 9.11.1.1 AutoTokenizer: From Text to Token IDs
...
### 9.11.1.2 AutoModel: The Transformer Backbone
...
### 9.11.1.3 ModelOutput: Why It Is Not an Ordinary Tuple
...
## 9.11.2 Encoder-Only Models: Understanding Input Sequences
...
### 9.11.2.1 SequenceClassification: Encoder + Classification Head
...
### 9.11.2.2 TokenClassification: One Prediction per Token
...
### 9.11.2.3 A Complete Encoder-Only Example
...
## 9.11.3 Decoder-Only Models: Autoregressive Generation
...
### 9.11.3.1 CausalLM: Decoder-Only Language Models
...
### 9.11.3.2 `generate`: The Wrapper for Autoregressive Generation
...
### 9.11.3.3 `use_cache`: The KV Cache Interface
...
This corresponds exactly to what we discussed in Section 9.9.

### 9.11.3.4 A Complete Decoder-Only Example
...
This is the practical API manifestation of autoregressive generation and KV cache discussed in Sections 9.8 and 9.9.

## 9.11.4 Encoder-Decoder Models: Input-to-Output Sequence Conversion
...
### 9.11.4.1 Seq2SeqLM: Encoder-Decoder Generation Models
...
### 9.11.4.2 A Complete Encoder-Decoder Example
...
## 9.11.5 Model Internal Information: Attention and Hidden States
...
### 9.11.5.1 `output_attentions`: Extracting Attention Weights
...
### 9.11.5.2 `hidden_states`: Extracting Layer Representations
...
### 9.11.5.3 An Attention Visualization Interface Example
...
## 9.11.6 `labels`: Where the Training Loss Comes From
...
## 9.11.7 A Mapping Table from Structure to API
