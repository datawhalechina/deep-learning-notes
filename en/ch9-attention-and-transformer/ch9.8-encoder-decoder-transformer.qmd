...
open-graph:
  title: ch9.8-encoder-decoder-transformer
  description: "9.8 Encoder-Decoder Transformer: Connecting Encoder and Decoder"
title: "9.8 Encoder-Decoder Transformer: Connecting Encoder and Decoder"
order: 8
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/en/ch9-attention-and-transformer/ch9.8-encoder-decoder-transformer.ipynb){fig-align="left"}
...
## 9.9.1 From Seq2Seq to Conditional Autoregressive Generation
...
## 9.9.2 Information Flow in the Encoder-Decoder Transformer

The information flow of a complete Encoder-Decoder Transformer can be written as:

![Figure 9.9.2: Transformer network architecture diagram [@vaswani2023Attention, fig. 1]](figures/ch9.8-transformer.png){height=600px}
...
## 9.9.3 Teacher Forcing: Using Real Prefixes for Parallel Prediction During Training
...
## 9.9.4 Autoregressive Generation: Using the Model's Own Generated Prefix During Inference
...
:::{.list-table}
Table 9.9.4: Comparison Between Transformer Training and Inference
...
## 9.9.5 Masks in Encoder-Decoder
...
Table 9.9.5: Common Masks in Transformer
...
## 9.9.6 PyTorch Implementation of the Transformer

Now, let's implement a complete Encoder-Decoder Transformer. We will directly use the encoder block and decoder block implemented in 9.6 and 9.7 to build a complete Transformer model.
...
class Transformer(nn.Module):
    def __init__(
        ...
        encoder_norm = dnn.LayerNorm(d_model, eps=layer_norm_eps, bias=bias)
        ...
        decoder_norm = dnn.LayerNorm(d_model, eps=layer_norm_eps, bias=bias)
...
## 9.9.7 PyTorch Implementation of a Seq2Seq Transformer
...
Here, `SinusoidalPositionalEncoding` can use the version implemented in 9.5.
...
## 9.9.8 Training Process of the Seq2Seq Transformer
...
## 9.9.9 A Simple Autoregressive Generation Example
