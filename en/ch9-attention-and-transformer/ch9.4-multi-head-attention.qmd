...
open-graph:
  title: ch9.4-multi-head-attention
  description: "9.4 Multi-Head Attention: From Single Perspective to Multiple Perspectives"
title: "9.4 Multi-Head Attention: From Single Perspective to Multiple Perspectives"
order: 4
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/en/ch9-attention-and-transformer/ch9.4-multi-head-attention.ipynb){fig-align="left"}
...
## 9.4.1 The Problem with Single-Head Attention
...
## 9.4.2 The Core Idea of Multi-Head Attention
...
![Figure 9.4.2: MHA computation diagram [@vaswani2023Attention, fig. 2]](figures/ch9.4-mha.png){height=300px}
...
## 9.4.3 Why Multiple Heads Are Useful
...
## 9.4.4 Multiple Heads Do Not Simply Increase Parameters
...
## 9.4.5 Understanding Multi-Head Attention from Tensor Shapes
...
## 9.4.6 PyTorch Implementation of Multi-Head Attention
...
## 9.4.7 Why the Output Projection Is Still Needed
