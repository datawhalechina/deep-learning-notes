...
open-graph:
  ...
  description: "9.5 Positional Encoding: Adding Positional Information to Attention"
title: "9.5 Positional Encoding: Adding Positional Information to Attention"
order: 5
---

[![](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/jshn9515/dnnl-notebooks/blob/main/en/ch9-attention-and-transformer/ch9.5-positional-encoding.ipynb){fig-align="left"}
...
## 9.5.1 Why Attention Needs Positional Information
...
## 9.5.2 The Most Direct Method: Give Each Position a Vector
...
## 9.5.3 Why Addition Instead of Concatenation?
...
## 9.5.4 Sinusoidal Positional Encoding
...
class SinusoidalPositionalEncoding(nn.Module):
    ...
    def __init__(self, embed_dim: int, max_len: int = 5000):
        ...
        pos_embed[:, 1::2] = torch.cos(pos / div_term[: pos_embed[:, 1::2].size(1)])
...
## 9.5.5 Learnable Positional Encoding
...
class LearnablePositionalEmbedding(nn.Module):
    """Learnable Positional Embedding used in many modern Transformer models."""

    def __init__(self, embed_dim: int, max_len: int = 5000):
        super().__init__()
        self.embed_dim = embed_dim
        self.max_len = max_len
        self.embed = dnn.Embedding(max_len, embed_dim)
...
## 9.5.6 Where Positional Encoding Is Added
