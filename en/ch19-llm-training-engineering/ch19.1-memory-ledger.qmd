...
## 17.1.1 Where Does Training Memory Go?
...
## 17.1.2 Model States: How Much Memory Lies Behind One Parameter?
...
: Table 17.1.2 Theoretical storage sizes of common dtypes
...
### 17.1.2.3 AdamW Optimizer States
...
### 17.1.2.5 A Memory Estimation Technique for Large Models
...
: Table 17.1.2.1 Per-parameter memory ledger for AdamW training
...
: Table 17.1.2.2 Per-parameter memory ledger for AdamW with FP32 master weights
...
### 17.1.2.6 A 7B Model: Why 13 GiB of Weights Does Not Fit for Training
...
## 17.1.3 Activation Memory: What Must the Forward Pass Save?

Consider a simplified Transformer block:

![Figure 17.1.3 Transformer block](figures/ch19.1-transformer-block.png){height="350px"}
...
### 17.1.3.4 Why Activation Memory Cannot Be Calculated Exactly
...
## 17.1.4 Runtime Memory: Why Theory and Practice Do Not Match
...
![Figure 17.1.4 Allocated Memory and Reserved Memory](figures/ch19.1-memory.svg)
...
## 17.1.5 Peak Memory: What Actually Determines OOM?
...
## 17.1.6 Following Memory Through a Training Step
...
## 17.1.7 Observing Memory in PyTorch
...
## 17.1.8 Diagnosing the Memory Bottleneck from Where OOM Occurs
...
## 17.1.9 From the Memory Ledger to Training Optimizations
...
::: {.list-table}
Table 17.1.9 How training optimizations map to the memory ledger
